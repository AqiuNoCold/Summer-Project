...
public class UserDao implements BaseDao<User> {
    ...
    public boolean add(User user) {
        ...
        try {
            ...
            String sql = "INSERT INTO tblUser (id, pwd, age, gender, role, email, card, remain, password, lost) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public boolean update(User user) {
        ...
        try {
            conn = DbConnection.getConnection();
            String sql = "UPDATE tblUser SET pwd = ?, age = ?, gender = ?, role = ?, email = ?, card = ?, remain = ?, password = ?, lost = ? WHERE id = ?";
            pstmt = conn.prepareStatement(sql);
