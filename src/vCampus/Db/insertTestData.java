...
//                    + "('111111111', '111111111', 25, TRUE, 'ST', 'user001@example.com', '111111111', FALSE),"
...
//            logger.info("插入数据到 tblGrade 表成功。");
            ...
            String insertShopStudentSQL = "INSERT INTO tblShopStudent (id, card, favorites, belongs, bill) VALUES "
                    + "('213221798', '213221798', '2,0', '8,10,11', ''),"
                    + "('987654321', '987654321', '1,2', '0,1,2,3,4,5,6,7,9', ''),"
                    + "('111111111', '111111111', '', '', '')";
